...
const char mensajePROD1[] = "P: 1       Q: /1"; //Hacemos unos const char con los mensajes de productos seleccionados.
const char mensajePROD2[] = "P: 2       Q: /2";
const char mensajePROD3[] = "P: 3       Q: /3";
const char mensajePROD4[] = "P: 4       Q: /4";
...
void loop() {
  ...
  if (digitalRead(boton1Pin) == HIGH && SELECMOTOR == 0) { //PRODUCTO UNO SELECCIONADO.
    saldo = 0; 
    SELECMOTOR = 1;
    SERVOS.write(180);
    lcd.clear();
  ...
  if (SELECMOTOR == 1 && saldo == 1) {
    ...
    if (digitalRead(boton2Pin) == HIGH && SELECMOTOR == 0) { //PRODUCTO DOS SELECCIONADO.
    saldo = 0; 
    SELECMOTOR = 2;
    SERVOS.write(180);
    lcd.clear();
  ...
  if (digitalRead(SIGNALINPUT3) == HIGH && SELECMOTOR == 0 ) { //PRODUCTO TRES SELECCIONADO.
    saldo = 0; 
    SELECMOTOR = 3;
    SERVOS.write(180);
    lcd.clear();
  ...
  if (digitalRead(SIGNALINPUT4) == HIGH && SELECMOTOR == 0 ) { //PRODUCTO CUATRO SELECCIONADO.
    saldo = 0; 
    SELECMOTOR = 4;
    SERVOS.write(180);
    lcd.clear();
